...
COORDINATE_ALGEBRA_2018.config <- list(
  COORDINATE_ALGEBRA.2018 = list( #  --  <1500 :: Include for SGP_NOTE
  ...
  COORDINATE_ALGEBRA.2018 = list( #18
    sgp.content.areas=c('MATHEMATICS', 'COORDINATE_ALGEBRA'),
...
) ### END COORDINATE_ALGEBRA_2018.config


### Analytic Geometry

ANALYTIC_GEOMETRY_2018.config <- list(
  ANALYTIC_GEOMETRY.2018 = list( #  --  <1500 :: Include for SGP_NOTE
...
###  Cohort > 1,500
  ...
  ANALYTIC_GEOMETRY.2018 = list( #25
    sgp.content.areas=c('COORDINATE_ALGEBRA', 'ANALYTIC_GEOMETRY'),
    sgp.panel.years=c('2017', '2018'),
    sgp.grade.sequences=list(c('EOCT', 'EOCT')),
    sgp.panel.years.within=c('LAST_OBSERVATION', 'FIRST_OBSERVATION'),
  ...
  ANALYTIC_GEOMETRY.2018 = list( #26
    sgp.content.areas=c('MATHEMATICS', 'COORDINATE_ALGEBRA', 'ANALYTIC_GEOMETRY'),
    sgp.panel.years=c('2016', '2017', '2018'),
  ...
  ANALYTIC_GEOMETRY.2018 = list( #27
    sgp.content.areas=c('MATHEMATICS', 'COORDINATE_ALGEBRA', 'ANALYTIC_GEOMETRY'),
    sgp.panel.years=c('2016', '2017', '2018'),
  ...
  ANALYTIC_GEOMETRY.2018 = list( #28
    sgp.content.areas=c('ANALYTIC_GEOMETRY', 'ANALYTIC_GEOMETRY'),
    sgp.panel.years=c('2017', '2018'),
    sgp.grade.sequences=list(c('EOCT', 'EOCT')),
    sgp.panel.years.within=c('LAST_OBSERVATION', 'FIRST_OBSERVATION'),
...
ALGEBRA_I_2018.config <- list(
  ...
  ALGEBRA_I.2018 = list( #  --  <1500 :: Include for SGP_NOTE
  ...
  ALGEBRA_I.2018 = list( #38a #  --  <1500 :: Include for SGP_NOTE
    ...
    sgp.exclude.sequences = data.table(VALID_CASE = 'VALID_CASE', CONTENT_AREA=c('MATHEMATICS', 'ALGEBRA_I', 'GEOMETRY'),
                                       YEAR=c('2017', '2017', '2017'), GRADE=c('8', 'EOCT', 'EOCT')),
    sgp.projection.grade.sequences="NO_PROJECTIONS",
    sgp.norm.group.preference=997),

  ###  Cohort > 1,500

  ALGEBRA_I.2018 = list( #29
    sgp.content.areas=c('MATHEMATICS', 'ALGEBRA_I'),
    sgp.panel.years=c('2015', '2018'),
    sgp.grade.sequences=list(c('8', 'EOCT')),
    sgp.panel.years.within=c('LAST_OBSERVATION', 'FIRST_OBSERVATION'),
...
GEOMETRY_2018.config <- list(
  GEOMETRY.2018 = list( #  --  <1500 :: Include for SGP_NOTE
  ...
  GEOMETRY.2018 = list( #38b #  --  <1500 :: Include for SGP_NOTE
