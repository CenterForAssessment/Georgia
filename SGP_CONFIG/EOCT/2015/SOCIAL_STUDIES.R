...
ECONOMICS_2015.config <- list(
	...
	ECONOMICS.2015 = list( #60
		sgp.content.areas=c('SOCIAL_STUDIES', 'US_HISTORY', 'ECONOMICS'),
		sgp.panel.years=c('2011', '2013', '2015'),
		...
		sgp.exclude.sequences = data.table(VALID_CASE = 'VALID_CASE', CONTENT_AREA=c('SOCIAL_STUDIES', 'US_HISTORY', 'ECONOMICS'), 
			YEAR=c('2011', '2013', '2015'), GRADE=c(8, 'EOCT', 'EOCT')),
	...
	ECONOMICS.2015 = list( #65
		...
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=3),
	ECONOMICS.2015 = list( #66
		sgp.content.areas=c('SOCIAL_STUDIES', 'US_HISTORY', 'ECONOMICS'),
		sgp.panel.years=c('2011', '2014', '2015'),
		sgp.grade.sequences=list(c(8, 'EOCT', 'EOCT')),
		sgp.panel.years.within=c('LAST_OBSERVATION', 'LAST_OBSERVATION', 'FIRST_OBSERVATION'),
		sgp.exact.grade.progression=TRUE,
		sgp.exclude.sequences = data.table(VALID_CASE = 'VALID_CASE', CONTENT_AREA=c('SOCIAL_STUDIES', 'US_HISTORY', 'ECONOMICS'), 
			YEAR=c('2011', '2014', '2015'), GRADE=c(8, 'EOCT', 'EOCT')),		
		sgp.norm.group.preference=2),
	ECONOMICS.2015 = list( #67
		sgp.content.areas=c('SOCIAL_STUDIES', 'US_HISTORY', 'ECONOMICS'),
		...
		sgp.exact.grade.progression=TRUE,
		sgp.exclude.sequences = data.table(VALID_CASE = 'VALID_CASE', CONTENT_AREA=c('SOCIAL_STUDIES', 'US_HISTORY', 'ECONOMICS'), 
			YEAR=c('2012', '2014', '2015'), GRADE=c(8, 'EOCT', 'EOCT')),		
		sgp.norm.group.preference=1),
	ECONOMICS.2015 = list( #68
		sgp.content.areas=c('US_HISTORY', 'ECONOMICS'),
		sgp.panel.years=c('2015', '2015'),
		sgp.grade.sequences=list(c('EOCT', 'EOCT')),
