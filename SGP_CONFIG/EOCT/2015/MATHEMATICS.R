######################################################################################################
###
### Scripts associated with 2015 CRCT & EOCT MATHEMATICS (Coordinate Algebra and Analytic Geometry)
###
######################################################################################################
...
COORDINATE_ALGEBRA_2015.config <- list(
	...
	COORDINATE_ALGEBRA.2015 = list( #15
		...
		sgp.exact.grade.progression=TRUE,
		sgp.exclude.sequences = data.table(VALID_CASE = 'VALID_CASE', CONTENT_AREA=c('MATHEMATICS', 'MATHEMATICS', 'COORDINATE_ALGEBRA'), 
