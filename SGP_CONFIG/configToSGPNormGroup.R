...
GA_EOCT_2012.config <- c(
	...
	ALGEBRA_2012.config, GEOMETRY_2012.config, MATHEMATICS_I_2012.config, MATHEMATICS_II_2012.config)
...
GA_EOCT_2013.config <- c(
	...
	COORDINATE_ALGEBRA_2013.config, GEOMETRY_2013.config, MATHEMATICS_I_2013.config, MATHEMATICS_II_2013.config)
...
GA_EOCT_2014.config <- c(
	...
	ANALYTIC_GEOMETRY_2014.config, COORDINATE_ALGEBRA_2014.config, MATHEMATICS_II_2014.config)
