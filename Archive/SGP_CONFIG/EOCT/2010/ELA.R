######################################################################
###
### Scripts associated with 2010 EOCT ELA: GRADE_9_LIT & AMERICAN_LIT
###
######################################################################

### GRADE_9_LIT

GRADE_9_LIT_2010.config <- list(
	GRADE_9_LIT.2010 = list( # 1
	...
	GRADE_9_LIT.2010 = list( # 2
		sgp.content.areas=c('ELA', 'READING', 'ELA', 'READING', 'GRADE_9_LIT'),
		sgp.panel.years=c('2007', '2007', '2008', '2008', '2010'),
	...
	GRADE_9_LIT.2010 = list( # 3
		sgp.content.areas=c('ELA', 'READING', 'GRADE_9_LIT'),
		sgp.panel.years=c('2009', '2009', '2010'),
		sgp.grade.sequences=list(c(8,8, 'EOCT')),
		sgp.panel.years.within=c('LAST_OBSERVATION', 'LAST_OBSERVATION', 'FIRST_OBSERVATION'),
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=3),
	GRADE_9_LIT.2010 = list( # 4
		sgp.content.areas=c('ELA', 'READING', 'ELA', 'READING', 'GRADE_9_LIT'),
		sgp.panel.years=c('2008', '2008', '2009', '2009', '2010'),
		sgp.grade.sequences=list(c(7,7,8,8, 'EOCT')),
		sgp.panel.years.within=c('LAST_OBSERVATION', 'LAST_OBSERVATION', 'LAST_OBSERVATION', 'LAST_OBSERVATION', 'FIRST_OBSERVATION'),
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=2),
	GRADE_9_LIT.2010 = list( # 5
	...
	GRADE_9_LIT.2010 = list( # 6
		sgp.content.areas=c('GRADE_9_LIT', 'GRADE_9_LIT'),
		sgp.panel.years=c('2010', '2010'),
		sgp.grade.sequences=list(c('EOCT', 'EOCT')),
		sgp.panel.years.within=list(c('FIRST_OBSERVATION'), c('LAST_OBSERVATION')),
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=0)
) ### END GRADE_9_LIT_2010.config


### AMERICAN_LIT

AMERICAN_LIT_2010.config <- list(
	AMERICAN_LIT.2010 = list( # 7
	...
	AMERICAN_LIT.2010 = list( # 8
		sgp.content.areas=c('ELA', 'READING', 'GRADE_9_LIT', 'AMERICAN_LIT'),
		sgp.panel.years=c('2007', '2007', '2008', '2010'),
	...
	AMERICAN_LIT.2010 = list( # 9
		...
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=4),
	AMERICAN_LIT.2010 = list( # 10
		sgp.content.areas=c('ELA', 'READING', 'GRADE_9_LIT', 'AMERICAN_LIT'),
		sgp.panel.years=c('2008', '2008', '2009', '2010'),
		sgp.grade.sequences=list(c('8', '8', 'EOCT', 'EOCT')),
		sgp.panel.years.within=c('LAST_OBSERVATION', 'LAST_OBSERVATION', 'LAST_OBSERVATION', 'FIRST_OBSERVATION'),
		sgp.exact.grade.progression=TRUE,
		sgp.norm.group.preference=3),
	AMERICAN_LIT.2010 = list( # 11
