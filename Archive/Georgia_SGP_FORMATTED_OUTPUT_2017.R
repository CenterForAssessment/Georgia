...
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 775 & SUBJECT_CODE == 'ELA' & GRADE == '4'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 760 & SUBJECT_CODE == 'ELA' & GRADE == '5'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 820 & SUBJECT_CODE == 'ELA' & GRADE == '6'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 785 & SUBJECT_CODE == 'ELA' & GRADE == '7'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 730 & SUBJECT_CODE == 'ELA' & GRADE == '8'),  HOSS:='YES']

Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 715 & SUBJECT_CODE == 'MATHEMATICS' & GRADE == '4'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 725 & SUBJECT_CODE == 'MATHEMATICS' & GRADE == '5'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 700 & SUBJECT_CODE == 'MATHEMATICS' & GRADE == '6'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 740 & SUBJECT_CODE == 'MATHEMATICS' & GRADE == '7'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 755 & SUBJECT_CODE == 'MATHEMATICS' & GRADE == '8'),  HOSS:='YES']

Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 735 & SUBJECT_CODE == 'GRADE_9_LIT'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 750 & SUBJECT_CODE == 'AMERICAN_LIT'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 790 & SUBJECT_CODE == 'COORDINATE_ALGEBRA'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 810 & SUBJECT_CODE == 'ANALYTIC_GEOMETRY'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 785 & SUBJECT_CODE == 'ALGEBRA_I'),  HOSS:='YES']
Georgia_SGP_Data_LONG_2017_FORMATTED[which(SCALE_SCORE == 815 & SUBJECT_CODE == 'GEOMETRY'),  HOSS:='YES']
