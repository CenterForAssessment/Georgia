# Appendix B to the 2014 Georgia Growth Model Report
August 2013  
...
$$\hspace{2pt} \text{(1)} \hspace{55pt} \textit{Total MSE } = \frac{1}{n} \sum_ {i=1}^n \frac{1}{R} \sum_ {r=1}^R (\widehat{SGP}_ {i,r} - SGP_ i)^2$$
...
$$\hspace{2pt} \text{(2)} \hspace{55pt} \textit{Total MSE } = \frac{1}{n} \sum {i=1}^n \frac{1}{R} \sum_ {r=1}^R (\widehat{SGP}_ {i,r} - SGP_ i )$$

$$\hspace{2pt} \text{(3)} \hspace{55pt} \textit{SD Bias = Standard Deviation}_ {\textit{ across }i} (\frac{1}{R} \sum_ {r=1}^R \widehat{SGP}_ {i,r} - SGP_ i)$$
...
$$\hspace{2pt} \text{(4)} \hspace{55pt} X_ {Est.  True}= \text{Reliability} \times (X_ {OBSERVED}-\bar{X}_ {OBSERVED})+\bar{X}_ {OBSERVED}$$
