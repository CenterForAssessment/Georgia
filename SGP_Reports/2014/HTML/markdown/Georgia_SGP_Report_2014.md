...
<!-- LaTeX_Start
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 1:** Number of Valid CRCT Student Records by Grade and Subject for 2014\label{my}} 
\begin{center}
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 2:** Total Number of Valid EOCT Student Records by Subject for 2014\label{my}} 
\begin{center}
\begin{tabular}{ll}
\hline\hline
...
This section provides basic details about the calculation of student growth percentiles from Georgia state assessment data using the [R Software Environment](http://www.r-project.org/) in conjunction with the [SGP Package](http://www.sgp.io).  More in depth treatment of the data analysis process, including code examples, has been provided to GaDOE staff in the 2014 Calculation Manual.
...
The `SGPstateData` file also includes a lookup table that allows various functions in the SGP package to translate between the naming conventions used within them and the variable names that the GaDOE uses.  The 2014 data included an identifier for gifted and talented students, which was used in result summarizations.
...
The next section descibes the process by which the individual course progression analyses are established and how the preferencing system is included within their configuration code.
...
The EOCT content area progression specific analyses were then calculated using the configuration scripts described above.  The baseline referenced content areas were analyzed seperately from the cohort referenced subjects (mathematics domain).  This was done due to the computationally intensive nature of the calculations rather than necessity, as all relevent argument controls are specified in the configuration scripts.  As with the CRCT analyses, cohort referenced SIMEX corrected versions of all SGPs were eventually produced.^[Unlike the CRCT, EOCT cohort referenced SGPs use only 2 prior years of data as specified in the configuration scripts.]
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 3:** EOCT Median and Mean <em>Cohort</em> Referenced Student Growth Percentile by Content Area for 2014\label{my}} 
\begin{center}
\begin{tabular}{lll}
\hline\hline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 4:** CRCT Median (Mean) <em>Baseline</em> Student Growth Percentile by Grade and Content Area for 2014\label{}} 
\begin{center}
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 5:** EOCT Median and Mean <em>Baseline</em> Referenced Student Growth Percentile by Content Area for 2014\label{}} 
\begin{center}
\begin{tabular}{lll}
\hline\hline
\multicolumn{1}{c}{Content Area}&\multicolumn{1}{c}{Median SGP}&\multicolumn{1}{c}{Mean SGP}\tabularnewline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 6:** SIMEX Corrected EOCT Median and Mean <em>Cohort</em> Referenced Student Growth Percentile by Content Area for 2014\label{my}} 
\begin{center}
\begin{tabular}{lll}
\hline\hline
\multicolumn{1}{c}{Content Area}&\multicolumn{1}{c}{Median SGP}&\multicolumn{1}{c}{Mean SGP}\tabularnewline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 7:** SIMEX Corrected CRCT Median (Mean) <em>Baseline</em> Student Growth Percentile by Grade and Content Area for 2014\label{my}} 
\begin{center}
\begin{tabular}{lclllll}
\hline\hline
\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries }&\multicolumn{5}{c}{\bfseries Grades}\tabularnewline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 8:** SIMEX Corrected EOCT Median and Mean <em>Baseline</em> Referenced Student Growth Percentile by Content Area for 2014\label{my}} 
\begin{center}
\begin{tabular}{lll}
\hline\hline
\multicolumn{1}{c}{Content Area}&\multicolumn{1}{c}{Median SGP}&\multicolumn{1}{c}{Mean SGP}\tabularnewline
...
##### **Figure 1:**   Goodness of Fit Plot for 2014 ***Cohort*** Referenced 8<sup>th</sup> Grade ELA.
...
##### **Figure 2:**   Goodness of Fit Plot for 2014 ***Baseline*** Referenced 8<sup>th</sup> Grade ELA.
...
##### **Figure 3:**   Goodness of Fit Plot for 2014 ***SIMEX Corrected,*** Baseline Referenced 8<sup>th</sup> Grade ELA.
...
\multicolumn{6}{c}{\begin{minipage}[c]{0.764705882352941\linewidth}**Table 9:** CRCT Correlations between Student-Level Prior Standardized Scale Score and SGP Versions\end{minipage}}\\ 
\hline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 10:** Correlations between Student-Level Prior Standardized Scale Score and EOCT Baseline Referenced SGP Versions\label{my}} 
\begin{center}
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 11:** Correlations between Student-Level Prior Standardized Scale Score and EOCT Cohort Referenced SGP Versions\label{my}} 
\begin{center}
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 12:** Correlations between Mean Prior Standardized Scale Score and Aggregate SGPs - (Combined Subjects)\label{my}} 
\begin{center}
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 13:** CRCT Correlations between School-Level Mean Prior Standardized Scale Score and (Baseline) SGP Aggregations.\label{my}} 
\begin{center}
\begin{tabular}{lcllll}
\hline\hline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 14:** 2014 CRCT Correlations between School-Level prior standardized scale score and Aggregate (Baseline) SGPs by Grade.\label{my}} 
\begin{center}
\begin{tabular}{lcllll}
\hline\hline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 15:** 2011 to 2014 Correlations between Mean Prior Standardized Scale Score and Aggregate Baseline SGPs.\label{my}} 
\begin{center}
\begin{tabular}{lcllll}
\hline\hline
\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries }&\multicolumn{4}{c}{\bfseries Aggregate SGP Type}\tabularnewline
...
%latex.default(my_tbl, file = "", where = where, caption = tmp_caption,     ...)%
\begin{table}[!htbp]
\caption{**Table 16:** 2011 to 2014 Correlations between Mean Prior Standardized Scale Score and Cohort SGPs.\label{my}} 
\begin{center}
\begin{tabular}{lcllll}
\hline\hline
\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries }&\multicolumn{4}{c}{\bfseries Aggregate SGP Type}\tabularnewline
