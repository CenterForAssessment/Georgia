...
Targets are initially established in the prior academic year, so that students' growth towards specific targets in the current year are considered relative to growth norms from the previous years' cohort.  The 2018 growth target analyses will be used in the [Georgia visualization tool](http://gastudentgrowth.gadoe.org/) to provide stakeholders with prospective information about student growth needs in the current year.  The 2018 targets will also be "banked" and used to compare with 2019 SGPs to determine growth adequacy.  The following sections provide descriptive statistics of the 2018 growth target results.
...
```{r, results='asis', echo=FALSE, Target_Sum_EOC}
  ...
  cat(dualTable(as.matrix(target_smry_B), title="", n.cgroup=c(1, 1, dim(target_smry_B)[2]-2), cgroup=c("", "", "Growth Targets"),
  	align=paste(rep('r', dim(target_smry_B)[2]), collapse=''),
...
```{r, results='asis', echo=FALSE, Target_Cor_EOG}
	...
	tmp.cap <- "EOG Student Level Correlations between 2018 Growth Target and Current Scale Score."
...
```{r, results='asis', echo=FALSE, Target_Cor_EOC}
	...
	tmp.cap <- "EOC Student Level Correlations between 2018 Growth Target and Current Scale Score."
