...
<img src="../img/Appendices/Appendix_B/Fig_1_TMP.jpg" alt="errorDensity" style="width: 600px; margin-right: 90px; padding: 10px; float: left;"/></div>
</div>

<!-- LaTeX_Start
![**Fig.  B.1**  *Absolute values of SGP Errors with 1 and 2 Priors Used*](../img/Appendices/Appendix_B/Fig_1_TMP.jpg 'errorDensity')
LaTeX_End -->
...
<div class='image-content'>    
<img src="../img/Appendices/Appendix_B/Fig_2_True_Vs_Obs_Regression.png" alt="trueVobsRegression" style="width: 600px; padding: 10px;"/>
</div>
</div>

<!-- LaTeX_Start
![**Fig.  B.2**](../img/Appendices/Appendix_B/Fig_2_True_Vs_Obs_Regression.png 'trueVobsRegression')
LaTeX_End -->
...
<div class='image-content'>    
<img src="../img/Appendices/Appendix_B/Fig_3_SIMEX_GoF.png" alt="simexGoF" style="width: 600px; padding: 10px;"/>
</div>
</div>

<!-- LaTeX_Start
![**Figure B.3**  *Goodness of Fit plot for SIMEX SGPs obtained from one 4<sup>th</sup> grade simulation*](../img/Appendices/Appendix_B/Fig_3_SIMEX_GoF.png 'simexGoF')
LaTeX_End -->
...
<div class='image-content'>    
<img src="../img/Appendices/Appendix_B/Fig_4_Aggregate_Errors_G3.png" alt="aggError3" style="width: 600px; padding: 10px;"/>
</div>
</div>

<!-- LaTeX_Start
![**Figure B.4**   *Errors of Aggregated and Individual Scale Scores of Grade 3*](../img/Appendices/Appendix_B/Fig_4_Aggregate_Errors_G3.png 'aggError3')
LaTeX_End -->
...
<div class='image-content'>    
<img src="../img/Appendices/Appendix_B/Fig_5_Aggregate_Errors_G4.png" alt="aggError4" style="width: 600px; padding: 10px;"/>
</div>
</div>

<!-- LaTeX_Start
![**Figure B.5**  *Errors of Aggregated and Individual SGPs of Grade 4*](../img/Appendices/Appendix_B/Fig_5_Aggregate_Errors_G4.png 'aggError4')
LaTeX_End -->
...
<div class='image-content'>    
<img src="../img/Appendices/Appendix_B/Fig_6_School_MGP_Diff.png" alt="mgpDiff" style="width: 600px; padding: 10px;"/>
</div>
</div>

<!-- LaTeX_Start
![**Figure B.6**  *SGP_SIMEX minus SGP Plotted against School Mean Standardized Prior Scores for American Literature*](../img/Appendices/Appendix_B/Fig_6_School_MGP_Diff.png "mgpDiff")
LaTeX_End -->
...
<div class='image-content'>    
<img src="../img/Appendices/Appendix_B/Fig_7_School_Rank_Diff.png" alt="stabilityMGP" style="width: 600px; padding: 10px;"/>
</div>
</div>

<!-- LaTeX_Start
![**Figure B.7**  *Difference in School Ranking in Different SIMEX Trials Plotted Against School Size for American Literature*](../img/Appendices/Appendix_B/Fig_7_School_Rank_Diff.png "stabilityMGP")
LaTeX_End -->
