...
```{r, results="asis", echo=FALSE, ELA_Cond_Dists2}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOG-3.png", "../img/Appendices/Appendix_C_2017/condDist_EOG-4.png",
								"../img/Appendices/Appendix_C_2017/condDist_EOG-5.png"),
...
```{r, results="asis", echo=FALSE, Math_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOG-6.png", "../img/Appendices/Appendix_C_2017/condDist_EOG-7.png",
								"../img/Appendices/Appendix_C_2017/condDist_EOG-8.png", "../img/Appendices/Appendix_C_2017/condDist_EOG-9.png",   
								"../img/Appendices/Appendix_C_2017/condDist_EOG-10.png"),
...
For example, the middle-right plot in Figure C.6 below for Algebra I course repeaters shows that the cohort is low achieving (as expected for students retaking the test) but there are seven students that attained the HOSS (785) in 2017.  One also had a perfect score in 2016 and has an unexpectedly low SGP of 14 (data point in the upper-right hand corner).  Another student of interest in this cohort scored the HOSS in 2016 and slightly lower in 2017, and has a SGP rank of 1. Both SGPs are probably an inaccurate assessments of the students' growth since they have attained perfect or near perfect scores two years in a row.  Given the sparsity of data points in the high achievement regions, the SGP model has struggled to produce appropriate growth estimates.  Several other plots in other subjects also display a similar patterns.
...
# table(long.data[YEAR==current.year & CONTENT_AREA=="GRADE_9_LIT", Most_Recent_Prior])
	...
	condDistPlot(ca="GRADE_9_LIT", g="EOCT", prior.ca="2016/ELA_7")
	...
	condDistPlot(ca="AMERICAN_LIT", g="EOCT", prior.ca="2016/AMERICAN_LIT_EOCT")
	...
	condDistPlot(ca="COORDINATE_ALGEBRA", g="EOCT", prior.ca="2016/MATHEMATICS_7")
	condDistPlot(ca="COORDINATE_ALGEBRA", g="EOCT", prior.ca="2015/MATHEMATICS_8")
	condDistPlot(ca="COORDINATE_ALGEBRA", g="EOCT", prior.ca="2016/MATHEMATICS_8")
	condDistPlot(ca="COORDINATE_ALGEBRA", g="EOCT", prior.ca="2016/COORDINATE_ALGEBRA_EOCT")

	condDistPlot(ca="ANALYTIC_GEOMETRY", g="EOCT", prior.ca="2016/COORDINATE_ALGEBRA_EOCT")
	condDistPlot(ca="ANALYTIC_GEOMETRY", g="EOCT", prior.ca="2016/ANALYTIC_GEOMETRY_EOCT")

	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016/MATHEMATICS_7")
	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2015/MATHEMATICS_8")
	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016/MATHEMATICS_8")
	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016/ALGEBRA_I_EOCT")
	...
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2016/ALGEBRA_I_EOCT")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2017/ALGEBRA_I_EOCT")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2016/GEOMETRY_EOCT")
...
```{r, results="asis", echo=FALSE, G9Lit_Cond_Dists}
		placeFigure(
			...
			rows = 2, columns = 2, page.break= TRUE, pdf.width = 0.5,
			caption = "Conditional distribution(s) of current and prior scale scores: 9<sup>th</sup> Grade Lit.")
```


```{r, results="asis", echo=FALSE, AmLit_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOC-5.png", "../img/Appendices/Appendix_C_2017/condDist_EOC-6.png",
			...
			rows = 3, columns = 2, page.break= TRUE, pdf.width = 0.5,
			caption = "Conditional distribution(s) of current and prior scale scores: American Lit.")
```


```{r, results="asis", echo=FALSE, Alg1_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOC-16.png", "../img/Appendices/Appendix_C_2017/condDist_EOC-17.png",
...
```{r, results="asis", echo=FALSE, Geom_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOC-21.png", "../img/Appendices/Appendix_C_2017/condDist_EOC-22.png",
...
```{r, results="asis", echo=FALSE, CoordAlg_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOC-10.png", "../img/Appendices/Appendix_C_2017/condDist_EOC-11.png",
			...
			caption = "Conditional distribution(s) of current and prior scale scores: Coordinate Algebra.")
```


```{r, results="asis", echo=FALSE, AnGeom_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/condDist_EOC-14.png", "../img/Appendices/Appendix_C_2017/condDist_EOC-15.png"),
			rows = 1, columns = 2, page.break= TRUE, pdf.width = 0.475,
			caption = "Conditional distribution(s) of current and prior scale scores: Analytic Geometry.")
```
...
```{r, echo=FALSE, include=FALSE, cache=TRUE, HOSS_Box_EOC, fig.height=4, fig.width=7}
	...
	# max.data[CONTENT_AREA %in% "COORDINATE_ALGEBRA" & SCALE_SCORE==HOSS_1 & Most_Recent_Prior=="2016/COORDINATE_ALGEBRA_EOCT"] # 2 interesting cases
	# max.data[CONTENT_AREA %in% "BIOLOGY" & SCALE_SCORE==HOSS_1 & Most_Recent_Prior=="2016/BIOLOGY_EOCT"]
...
The plots for the Algebra I course repeater (2016) progression is notable.  This progression can also be seen in Figure C.6 above.  Here the student who scored the HOSS consecutively has an unexpectedly low SGP of 14.  Another student of interest in in this analysis scored the HOSS in 2017, and slightly lower in 2016.  This student's SGP was estimated to be 73; substantially higher, but still lower than one might expect.  These students are outliers in the data and it is not surprising that the SGP estimates of their growth are questionable.
...
```{r, results="asis", echo=FALSE, Alg1_HOSS}
		placeFigure(
			...
			rows = 2, columns = 1, page.break= TRUE, pdf.width = 0.95,
			caption = "EOC SGP distributions for the HOSS and LOSS scores by norm group: Algebra I.")
```

```{r, results="asis", echo=FALSE, Geom_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_2017/HOSS_Box_EOC-7.png", "../img/Appendices/Appendix_C_2017/LOSS_Box_EOC-7.png"),
			rows = 2, columns = 1, page.break= TRUE, pdf.width = 0.93,
