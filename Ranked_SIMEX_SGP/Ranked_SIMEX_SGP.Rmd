...
#	CONTENT_AREA %in% c("BIOLOGY","PHYSICAL_SCIENCE","COORDINATE_ALGEBRA","ANALYTIC_GEOMETRY", "ALGEBRA_I", "GEOMETRY")] 
#	CONTENT_AREA %in% c("GRADE_9_LIT", "AMERICAN_LIT", "ECONOMICS", "US_HISTORY")]
