...
```{r, results='asis', echo=FALSE, GoF_Standard}
	placeFigure(
		files = "./img/gofSGP_Grade_8_Standard.png", 
		pdf.width=0.7, 
...
```{r, results='asis', echo=FALSE, GoF_SIMEX}
	placeFigure(
		files = "./img/gofSGP_Grade_8_SIMEX.png", 
		pdf.width=0.65, 
...
```{r, results='asis', echo=FALSE, GoF_Ranked}
	placeFigure(
		files = "./img/gofSGP_Grade_8_RANKED.png", 
		pdf.width=0.65, 
...
```{r, results='asis', echo=FALSE, School_Diff_Plots_EOC3}
	placeFigure(
		files = "./img/School_Diff_Plots_EOC3.pdf",
		caption = "School MGP change (MGP Ranked SIMEX - MGP SIMEX) by EOC Subjects (Continued).")
