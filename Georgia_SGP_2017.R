...
Georgia_SGP <- updateSGP(
  ...
  with_sgp_data_LONG=Georgia_Data_LONG_2017,
  ...
  calculate.simex = list(lambda=seq(0,2,0.5), simulation.iterations=7, simex.sample.size=1500, csem.data.vnames="SCALE_SCORE_CSEM", extrapolation="linear", save.matrices=TRUE),
