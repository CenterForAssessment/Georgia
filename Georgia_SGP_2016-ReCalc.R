...
Georgia_SGP@SGP[["Coefficient_Matrices"]] <- Georgia_SGP@SGP[["Coefficient_Matrices"]][1:8]
...
Georgia_SGP <- updateSGP(
  ...
  load("Data/Georgia_Data_LONG_2016_EOC.Rdata") # Uses new data uploaded by Tianna 10/11/2016
