###########################################################################
###                                                                     ###
###     Re-calculate SGPs for Georgia without IAPP Districts - 2019     ###
###                                                                     ###
###########################################################################
...
Georgia_SGP@Data <- Georgia_SGP@Data[!DISTRICT_NUMBER %in% IAPP_Districts]
Georgia_Data_LONG_2019_EOG <- Georgia_Data_LONG_2019_EOG[!SR_SYSTEM_ID %in% IAPP_Districts]
Georgia_Data_LONG_2019_EOC <- Georgia_Data_LONG_2019_EOC[!SR_SYSTEM_ID %in% IAPP_Districts] # Remove 2017 Test Out students - already in Shell
...
# Georgia_SGP@Data[which(duplicated(Georgia_SGP@Data, by=key(Georgia_SGP@Data)))-1, VALID_CASE := "INVALID_CASE"] # 0 new invalid for 2019 IAPP

###  Read in 2019 SGP Configuration Scripts
source("/media/Data/Dropbox/Github_Repos/Projects/Georgia/SGP_CONFIG/EOCT/2019/ELA.R")
source("/media/Data/Dropbox/Github_Repos/Projects/Georgia/SGP_CONFIG/EOCT/2019/MATHEMATICS.R")
...
Georgia_Data_LONG_2019_EOC_Fall_Spring <- Georgia_Data_LONG_2019_EOC[YEAR_WITHIN %in% 1:2]

GA_TMP_SGP <- updateSGP(
    what_sgp_object=Georgia_SGP,
    with_sgp_data_LONG=Georgia_Data_LONG_2019_EOC_Fall_Spring,
...
Georgia_EOC_Coef_Matrices_2019 <- GA_TMP_SGP@SGP$Coefficient_Matrices
save(Georgia_EOC_Coef_Matrices_2019, file="Data/Georgia_EOC_Coef_Matrices_2019-reduced.rda")
...
load("Data/Georgia_EOC_Coef_Matrices_2019-reduced.rda")
...
save(Georgia_SGP, file="Data/Georgia_SGP_IAPP_2019.Rdata")
