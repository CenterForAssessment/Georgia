#####################################################################################
###                                                                               ###
###    Script to produce formatted text output for Georgia from 2019 long data    ###
###                                                                               ###
#####################################################################################
...
###   GA DOE
load("U:/DATA/SGP/Data/2019 SGPs/2019 SGP Calculation/Working Directory_QQ/Data/Georgia_SGP_LONG_Data_2019.Rdata")
load("U:/DATA/SGP/Data/2019 SGPs/2019 SGP Calculation/Working Directory_QQ/Data/Georgia_SGP.Rdata")
...
tmp.long.data <- subset(Georgia_SGP_LONG_Data_2019, select=intersect(variables.to.output, names(Georgia_SGP_LONG_Data_2019)))
...
Georgia_SGP_Data_LONG_2019_FORMATTED <- tmp.projections.c[tmp.long.data, allow.cartesian=TRUE]
setnames(Georgia_SGP_Data_LONG_2019_FORMATTED, "SGP_PROJECTION_GROUP", "SGP_PROJECTION_GROUP_CURRENT")


###  Final arrangement of variables
Georgia_SGP_Data_LONG_2019_FORMATTED <- Georgia_SGP_Data_LONG_2019_FORMATTED[, variables.to.output, with=FALSE]

setnames(Georgia_SGP_Data_LONG_2019_FORMATTED, c("LEVEL_1_SGP_TARGET_YEAR_1_CURRENT", "LEVEL_2_SGP_TARGET_YEAR_1_CURRENT", "LEVEL_3_SGP_TARGET_YEAR_1_CURRENT"),
...
setkeyv(Georgia_SGP_Data_LONG_2019_FORMATTED, c("VALID_CASE", "SUBJECT_CODE", "SCHOOL_YEAR", "GTID", "YEAR_WITHIN"))
